...
|---------------------|---------------------|--------------|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.** | Rocha Cotrina, Álvaro: Elaboración de User Stories y Epics, Web Applications Mock-ups, General y Web Style Guidelines, Desktop Mockups, Organization Systems, Labeling Systems, Navigation Systems, Searching Systems, Ubiquitous Language, Software Configuration Management y Registro de Entrevistas. | El trabajo desarrollado permitió evidenciar la capacidad de integrarse de manera efectiva en un equipo multidisciplinario, contribuyendo activamente al liderazgo compartido, la coordinación de tareas y el cumplimiento de objetivos comunes. |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.** | Esquicha Alcántara, Diego Alonso: Registro de Entrevistas, User Stories, Class and Database Diagrams Information, Web Application User Flow Diagram, configuración del entorno de desarrollo, Source Code Style Guide & Conventions y elaboración del PPT grupal. | A lo largo del proyecto se demostró un desempeño adecuado dentro de un entorno colaborativo, participando en la planificación, ejecución y seguimiento de actividades, lo que permitió cumplir los objetivos establecidos de manera conjunta. |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.** | Quispe Llacsahuanga, César Augusto: Class Diagram, Database Diagrams, Web Applications Wireframes, Style Guidelines, User Stories, Lean UX, Web Applications Mock-ups, Organization Systems, SEO Tags and Meta Tags, Navigation Systems, Landing Page Mock-up y Registro de Entrevistas. | El desarrollo del trabajo evidenció la capacidad de colaborar de forma efectiva en equipo, respetando las ideas de los demás e impulsando un ambiente inclusivo que favoreció el avance ordenado del proyecto. |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.** | Guillen Giraldo, Mike Dylan: Lean UX Process, Segmentos objetivo, Needfinding, User Personas, User Task Matrix, User Journey Mapping, User Stories, Product Backlog, Navigation Systems, Landing Page UI Design, Wireframes, Mock-ups, EventStorming, Sprint Backlog y evidencias de Sprint Review. | Durante el proyecto se fortaleció la habilidad de trabajo en equipo mediante la participación activa en la definición de metas, distribución de responsabilidades y seguimiento de avances, logrando resolver problemas de manera eficiente. |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.** | Teran Zavala, Mauricio Alejandro: Antecedentes y problemática, Registro de Entrevistas, User Personas, User Task Matrix, User Journey Mapping, Empathy Mapping, User Stories, Product Backlog, UX/UI Design, diagramas de arquitectura de software, Sprint Planning y Student Outcome. | El proyecto permitió demostrar competencias para integrarse a un equipo de trabajo, aportando al liderazgo colectivo y a la planificación adecuada de tareas, lo que facilitó el cumplimiento de los objetivos del proyecto. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos.** | Todos los integrantes participaron en la coordinación de actividades, planificación de entregables, revisiones colaborativas y apoyo mutuo durante las distintas fases del proyecto. | El equipo consolidó un entorno colaborativo e inclusivo que permitió establecer metas claras, planificar tareas de forma organizada y cumplir los objetivos académicos y del proyecto dentro de los plazos definidos. |
