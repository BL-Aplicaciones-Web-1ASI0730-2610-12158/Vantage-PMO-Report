...
| **TB2** | 06/07/2026 | Rocha, Alvaro<br>Esquicha, Diego<br>Guillen, Dylan<br>Quispe, César<br>Teran Zavala, Mauricio Alejandro | **Capítulo V — Product Implementation:** Para la entrega TB2, correspondiente a la entrega final del proyecto, se consolidó la documentación completa del ciclo de desarrollo del producto Vantage PMO, integrando los resultados obtenidos durante los Sprints 1, 2, 3 y 4. Se validó la implementación funcional de los principales módulos del sistema, asegurando la coherencia entre los requerimientos definidos, las User Stories desarrolladas y los entregables finales del producto.<br><br>Se realizó la estabilización del sistema, incluyendo la corrección de incidencias detectadas durante las revisiones previas, la optimización de la experiencia de usuario y la validación de flujos críticos como autenticación, gestión de proyectos, colaboración en tareas, visualización de reportes y monitoreo del progreso. Asimismo, se verificó el correcto funcionamiento de la arquitectura definida bajo el Modelo C4 y la integración entre frontend, backend y servicios desplegados.<br><br>Adicionalmente, se documentaron las evidencias finales de despliegue del sistema, la demostración funcional del producto (Product Demo), y los resultados obtenidos durante el Sprint Review final. Se incluyó la retrospectiva del equipo (Sprint Retrospective), identificando aprendizajes, oportunidades de mejora y buenas prácticas aplicadas durante el desarrollo del proyecto.<br><br>Finalmente, se actualizó y cerró la evaluación de los Student Outcomes ABET, se redactaron las conclusiones finales del proyecto y se incorporaron los anexos finales, evidenciando el cumplimiento de los objetivos académicos, técnicos y colaborativos, así como la madurez alcanzada por el producto Vantage PMO como solución integral para la gestión de proyectos y portafolios empresariales. |
